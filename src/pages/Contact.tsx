    ...
    <Layout>
      ...
      <section className="relative w-full h-[400px] md:h-[500px] bg-muted overflow-hidden">
        <img
          ...
          alt="Friendly customer interaction"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-black/30 flex items-center">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="max-w-lg bg-primary/90 backdrop-blur-sm p-5 md:p-6 rounded-lg">
              ...
              <p className="text-sm md:text-base text-white/90 leading-relaxed">
                We're here to help with order inquiries, shipping questions, and general product information.
              </p>
            </div>
          </div>
        </div>
